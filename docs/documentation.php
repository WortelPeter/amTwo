<div id="doclightbox">
  <div id="doctitle">.amTwo. -- docs</div>
  <div id="closelightbox">x</div>
  

  <div id="docmenu">about<br>privacy<br>security</div>
  <div id="doccatagorytitle">About / Contact</div>
  <div id="doccontent"><b>The standard Lorem Ipsum passage, used since the 1500s</b><br>
...
<script type='text/javascript'>
  ...
  document.onclick = function(e){
    ...
    while (target.parentNode) {
        ...
        if (target == lightbox || target == header) {
            display ='block';
            break;
        }
    ...
    if(display == 'none'){
    	$('#topbar').fadeIn('normal');
    	$('#doclightbox').slideUp('slow');
      $('#topbarregisterbutton').fadeIn('normal');
    	history.pushState("", document.title, window.location.pathname);
    }
    else{
    	$('#topbar').fadeOut('normal');
    	$('#doclightbox').slideDown('slow');
      $('#topbarregisterbutton').fadeOut('normal');
    }
